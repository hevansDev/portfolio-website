...
- [Bolts and Washers](https://amzn.to/4lDKHtU) (£8) - the load cell I picked had 4 holes for mounting, two threaded for M2 and two threaded for M3 bolts either way this selection should have everything you need including washers which are useful for making sure the strain gauges don't get pinched. I scavenged the bolts and washers I needed from some other projects.
